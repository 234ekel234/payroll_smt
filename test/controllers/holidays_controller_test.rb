...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { applies_to: @holiday.applies_to, date: @holiday.date, holiday_type: @holiday.holiday_type, name: @holiday.name, notes: @holiday.notes } }
