class EmployeesController < ApplicationController
  ...
  private
    ...
    def employee_params
      params.expect(employee: [ :name, :person_id, :company, :status_of_employment, :schedule, :basic_rate, :allowance_per_day, :landbank_atm, :shift_start, :shift_end, :break_start, :break_end ])
    end
end
